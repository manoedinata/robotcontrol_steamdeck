...
- PTZ camera control (pan/tilt via D-pad, zoom via shoulder buttons, focus via on-screen buttons on the left edge) using an optional ISAPI camera address with optional username and password
